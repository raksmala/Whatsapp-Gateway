            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li <?php if($this->uri->segment(2)=="Beranda"){echo 'class="active"';} ?>>
                        <a href="<?php echo base_url('Pengelola/Beranda');?>"><i class="menu-icon fa fa-laptop"></i>Dashboard </a>
                    </li>
                    <li <?php if($this->uri->segment(2)=="Sekolah"){echo 'class="active"';} ?>>
                        <a href="<?php echo base_url('Pengelola/Sekolah');?>"> <i class="menu-icon fa fa-building-o"></i>Profil Sekolah</a>
                    </li>
                    <li class="menu-item-has-children <?php if($this->uri->segment(2)!="Sekolah" and $this->uri->segment(2)!="Beranda"){echo 'active';} ?>">
