        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li <?php if($this->uri->segment(2)=="Beranda"){echo 'class="active"';} ?>>
                        <a href="<?php echo base_url('Superadmin/Beranda');?>"><i class="menu-icon fa fa-laptop"></i>Dashboard </a>
                    </li>
                    <li class="menu-item-has-children <?php if($this->uri->segment(2)!="Beranda"){echo 'active';} ?>">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><a href="<?php echo base_url('Superadmin/Pegawai');?>">Pegawai</a></li>
                            <li><a href="<?php echo base_url('Superadmin/User');?>">User</a></li>
                            <li><a href="<?php echo base_url('Superadmin/Sekolah');?>">Sekolah</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
